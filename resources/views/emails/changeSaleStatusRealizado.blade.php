...
<body style="width: 100% !important; margin: 0; padding: 0; mso-line-height-rule: exactly; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: #f4f4f4" class="">
  <div style="display: none !important; visibility: hidden; opacity: 0; overflow: hidden; mso-hide: all; height: 0; width: 0; max-height: 0; max-width: 0; font-size: 1px; line-height: 1px; color: #151515;">!Enhorabuena, tu compra ha sido exitosa! GRACIAS.</div>
              ...
              <tr>
                <td align="left" valign="top" style="padding: 0 10px;">
                            ...
                            <tbody>
                              <tr>
                                <td align="center" valign="top" style="padding: 10px;">
                                  <a href="#" style="text-decoration: none;"><img src="https://www.licoresmayorista.com/wp-content/uploads/2020/05/logo-licores-mayorista.png" width="130" height="22" alt="" style="height: auto; max-width: 100%; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; color: #ffffff; font-size: 14px;"></a>
                                </td>
                              </tr>
                              <tr>
                                        ...
                                        <td valign="top" style="font-size: 0;">
                                          ...
                                          <div class="pc-xs-w-100pc" style="display: inline-block; vertical-align: top;">
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                              <tbody>
                                                <tr>
                                                  <td class="pc-xs-p-10-0-0 pc-fb-font" valign="top" style="padding: 10px 15px 0 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; line-height: 34px; letter-spacing: -0.4px; color: #151515;">
                                                    Hola {{ $sale->buyer->full_name }}
                                                  </td>
                                                </tr>
                                              </tbody>
                                            </table>
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-fb-font" valign="top" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; padding: 10px 20px 0; line-height: 28px; font-size: 18px; font-weight: 300; letter-spacing: -0.2px; color: #9B9B9B;">
                                  !Enhorabuena, tu compra ha sido exitosa! GRACIAS.
                                </td>
                              </tr>
                              <tr>
                                                ...
                                                <tr>
                                                  <td width="60" valign="middle" style="padding: 6px 10px 0 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="60" role="presentation">
                                                      <tbody>
                                                        <tr>
                                                          <td valign="top">
                                                            <a href="http://example.com" style="text-decoration: none;"><img src="images/content-2-image-1.jpg" width="60" alt="" style="max-width: 100%; height: auto; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; border-radius: 6px; display: block;"></a>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                  ...
                                                  <td valign="middle">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="line-height: 20px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 300; letter-spacing: -0.2px; color: #1597bb;" valign="top">
                                                  ...
                                                  <td width="60" valign="middle" style="padding: 6px 10px 0 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="60" role="presentation">
                                                      <tbody>
                                                        <tr>
                                                          <td valign="top">
                                                            <a href="http://example.com" style="text-decoration: none;"><img src="images/content-2-image-2.jpg" width="60" alt="" style="max-width: 100%; height: auto; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; border-radius: 6px; display: block;"></a>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                  ...
                                                  <td width="60" valign="middle" style="padding: 6px 10px 0 0;">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="60" role="presentation">
                                                      <tbody>
                                                        <tr>
                                                          <td valign="top">
                                                            <img src="images/content-2-image-3.jpg" width="60" alt="" style="max-width: 100%; height: auto; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; border-radius: 6px; display: block;">
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                ...
                                                <tr>
                                                  ...
                                                  <td valign="middle">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="line-height: 20px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 300; letter-spacing: -0.2px; color: #29bb89;" valign="top">
                      ...
                      <tr>
                        <td class="pc-sm-p-30-20 pc-xs-p-25-10" style="padding: 40px 30px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-30 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 20px; font-weight: 800; line-height: 46px; letter-spacing: -0.6px; color: #151515; padding: 0 10px;" valign="top">
                                  Entrega a domicilio:
                                </td>
                              </tr>
                            </tbody>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td style="padding: 0 20px 0 0;" valign="top">
                                                            <img class="pc-fb-font" src="images/transactional-17-product-1-img.jpg" width="100" alt="" style="border: 0; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; display: block;">
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                        ...
                                                        <tr>
                                                          <td style="padding: 9px 0 0;" valign="top">
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                              <tbody>
                                                                <tr>
                                                                  <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; letter-spacing: -0.3px; line-height: 28px; font-weight: 500; font-size: 16px; color: #333; padding: 0 0 4px 0;" valign="top">
                                    ...
                                    @endforeach
                                      <tr>
                                      	...
                                      	<td colspan="3">
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="pc-fb-font" style="padding: 4px 0 2px; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #151515;" valign="top">
                                                    subtotal
                                                  </td>
                                                  <td class="pc-fb-font" style="padding: 4px 0 2px; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #151515;" valign="top" align="right">
                                                ...
                                                <tr>
                                                  ...
                                                  <td class="pc-fb-font" style="padding: 4px 0 2px; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #151515;" valign="top" align="right">
                                                    ${{ number_format($sale->shipping_costs, 2) }}
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="pc-fb-font" style="padding: 4px 0 2px; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; color: #151515;" valign="top">
                                                    TOTAL
                                                  </td>
                                                  <td class="pc-fb-font" style="padding: 4px 0 2px; letter-spacing: -0.2px; line-height: 26px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; color: #151515; font-weight: 800;" valign="top" align="right">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                    <tbody>
                      <tr>
                        <td class="pc-sm-p-25-10-15 pc-xs-p-15-0-5" valign="top" bgcolor="#ffffff" style=" background-color: #ffffff; border-radius: 8px;">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td style="font-size: 0;" valign="top">
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td class="pc-fb-font" style="line-height: 20px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 300; letter-spacing: -0.2px; color: #9B9B9B;" valign="top">
                                                            	...
                                                            	{{ $sale->buyer->profile->address }}<br>
                                                            	CP. {{ $sale->buyer->profile->postal_code }}<br>
																{{ $sale->buyer->profile->city }}<br>
																{{ $sale->buyer->profile->country }}, {{ $sale->buyer->profile->state }}<br>
																T: {{ $sale->buyer->profile->phone }}
                                              ...
                                              <tbody>
                                                <tr>
                                                  <td class="pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; letter-spacing: -0.2px; color: #D8D8D8;" valign="top">
                                                    Queda expresamente prohibida la reproducción total o parcial de este sitio web sin el permiso expreso y por escrito de Tequila online.
                                                  </td>
                                                </tr>
                                                <tr>
