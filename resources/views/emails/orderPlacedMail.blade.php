              ...
              <tr>
                <td align="left" valign="top" style="padding: 0 10px;">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody>
                      <tr>
                        <td class="pc-sm-p-20 pc-xs-p-10" bgcolor="#dddddd" valign="top" style="padding: 25px 30px; background-color: #dddddd; border-radius: 8px;">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                      ...
                      <tr>
                        <td class="pc-sm-p-25-10-15 pc-xs-p-15-0-5" valign="top" bgcolor="#ffffff" style="padding: 30px 20px 20px; background-color: #ffffff; border-radius: 8px;">
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-fb-font" valign="top" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; padding: 10px 20px 0; line-height: 28px; font-size: 18px; font-weight: 300; letter-spacing: -0.2px; color: #9B9B9B; text-transform: uppercase;">
                                  ¡GRACIAS POR COMPRAR EN <strong>{{ config('app.name') }}</strong>!
                                </td>
                              </tr>
                              <tr>
                      ...
                      <tr>
                        <td class="pc-sm-p-30-20 pc-xs-p-25-10" style="padding: 40px 30px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-xs-p-10-0-0 pc-fb-font" valign="top" style="padding: 10px 15px 0 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 700; line-height: 28px; letter-spacing: -0.4px; color: #151515;">
                                  PEDIDO <span style="color: #1687a7">{{ $sale->number_order }}</span> - EN ESPERA DE PAGO POR TRANSFERENCIA BANCARIA
                                </td>
                              </tr>
                              <tr>
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 30px; letter-spacing: -0.2px; color: #9B9B9B; padding: 0 10px" valign="top">
                                  Su pedido con el número de orden <strong><span style="color: #1687a7">{{ $sale->number_order }}</span></strong> ha sido realizado correctamente y será enviado tan pronto como recibamos su pago.<br><br>
                                  <div style="display: inline-block; text-align: center; border-radius: 8px; padding: 14px 19px; background-color: #1595E7;" bgcolor="#1595E7" valign="top" align="center">
                                    <a class="pc-fb-font" href="{{ $sale->url_pdf }}" target="_blanck" style="text-decoration: none; line-height: 24px; letter-spacing: -0.2px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 500; color: #ffffff; word-break: break-word; display: block;">Descargar Recibo</a>
                                  </div>
                                </td>
                              </tr>
                              <tr>
                        ...
                        <td class="pc-sm-p-30-20 pc-xs-p-25-10" style="padding: 40px 30px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-xs-p-10-0-0 pc-fb-font" valign="top" style="padding: 10px 15px 0 0; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 700; line-height: 28px; letter-spacing: -0.4px; color: #151515;">
                                  DATOS BANCARIOS PARA SU TRANSFERENCIA BANCARIA COMO FORMA DE PAGO.
                                </td>
                              </tr>
                              <tr>
                                <td height="15" style="line-height: 1px; font-size: 1px;">&nbsp;</td>
                            ...
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 30px; letter-spacing: -0.2px; color: #9B9B9B; padding: 0 10px" valign="top">
									<span><strong>Importe:</strong></span> ${{ number_format($sale->total, 2) }}<br>
									<span><strong>Titular de la cuenta:</strong></span> {bankwire_owner}<br>
									<span><strong>Datos de la cuenta:</strong></span> {bankwire_details}<br>
									<span><strong>Dirección bancaria:</strong></span> {bankwire_address}<br><br>
									<span>Por favor, incluya el <strong><span style="color: #1687a7">número de orden</span></strong> de su pedido en los detalles de la transferencia bancaria.</span>
                                </td>
                              </tr>
                              <tr>
                                <td height="25" style="line-height: 1px; font-size: 1px;">&nbsp;</td>
                        ...
                        <td class="pc-sm-p-30-20 pc-xs-p-25-10" style="padding: 40px 30px; background: #ffffff; border-radius: 8px;" bgcolor="#ffffff" valign="top">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-fs-18 pc-xs-fs-16 pc-fb-font" style="font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 30px; letter-spacing: -0.2px; color: #9B9B9B; padding: 0 10px" valign="top">
									<span>Puede revisar su pedido desde "Mis compras" de su cuenta de cliente, <a href="" style="color:#337ff1"> en nuestra tienda.</span>
                                </td>
                              </tr>
                              <tr>
                                <td height="25" style="line-height: 1px; font-size: 1px;">&nbsp;</td>
